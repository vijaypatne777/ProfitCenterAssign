		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UploadProftCenterAssignment",
									"targetURL": "#UploadProftCenterAssignment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UploadProftCenterAssignment-display": {
								"semanticObject": "UploadProftCenterAssignment",
								"action": "display",
								"description": "Upload Profit Center Assignment Data",
								"title": "UploadProftCenterAssignment",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=UploadProfit.UploadProftCenterAssignment",
									"url": sap.ui.require.toUrl("UploadProfit/UploadProftCenterAssignment")
								}
							}
						}
					}
