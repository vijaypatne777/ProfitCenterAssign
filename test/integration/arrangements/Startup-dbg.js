sap.ui.define([
	"sap/ui/test/Opa5",
	"UploadProfit/UploadProftCenterAssignment/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"UploadProfit/UploadProftCenterAssignment/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("UploadProfit.UploadProftCenterAssignment.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "YY1_FIN_CB_PROFIT_CENTER/" + sObjectId;
